...
table <<'EOF'
tests/form.loft|FORM OK|/tmp/hexbody_form.log|headings|[1/4] the 12 headings, the exact rotation and reflection (S0/S1) ...
tests/wall.loft|WALL OK|/tmp/hexbody_wall.log|walls|[2/4] the 24-direction wall: edge table, foxel write, mesh evaluation ...
tests/box.loft|BOX OK|/tmp/hexbody_box.log|boxes|[3/4] the box in 12 directions, thin wall and thick wall ...
tests/house.loft|HOUSE OK|/tmp/hexbody_house.log|house|[4/4] floor/walls/openings/roof at all 12 orientations ...
EOF
