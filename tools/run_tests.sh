...
tests/census.loft|CENSUS OK|/tmp/hexbody_census.log|census|[4/7] the census, grown by level: law F decided at levels 1-3 ...
...
tests/trip.loft|TRIP OK|/tmp/hexbody_trip.log|round trip|[7/7] rt_trip: write(rebuild(draw(read(T)))) == T over corpus a1+a2 ...
EOF
