...
table <<'EOF'
tests/form.loft|FORM OK|/tmp/hexbody_form.log|headings|[1/5] the 12 headings, the exact rotation and reflection (S0/S1) ...
tests/wall.loft|WALL OK|/tmp/hexbody_wall.log|walls|[2/5] the 24-direction wall: edge table, foxel write, mesh evaluation ...
tests/box.loft|BOX OK|/tmp/hexbody_box.log|boxes|[3/5] the box in 12 directions, thin wall and thick wall ...
tests/census.loft|CENSUS OK|/tmp/hexbody_census.log|census|[4/5] the level-1 census: law F decided at level 1 ...
tests/house.loft|HOUSE OK|/tmp/hexbody_house.log|house|[5/5] floor/walls/openings/roof at all 12 orientations ...
EOF
